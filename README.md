...
3. If the Dumping is Successful, you'll see a post at out Channel, [@Romdumprx](https://t.me/Romdumprx) on Telegram.

## Notes ##
- If the Dump is Successful, you'll see a post on our Telegram Channel, [@Romdumprx](https://t.me/Romdumprx)
- If the Dump Fails, you'll not see the post, and you'll have to check the Logs in Cirrus CI Website
- The Dumps are Pushed to [https://www.opencode.net/romdumprx](https://www.opencode.net/romdumprx
)
- Since this is Using only 2 Cores, Cirrus Waiting Time is Very less, Usually not more than a minute or two.
- This Script use [DumprX](https://github.com/DumprX/DumprX) to Dump the ROM/Firmware.
